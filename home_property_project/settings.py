...
ALLOWED_HOSTS = os.environ.get("DJANGO_ALLOWED_HOSTS", "real-estate-property.herokuapp.com" "127.0.0.1 localhost").split(" ")
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Database file location (in the project directory)
    }
}
